const api = {
  ...
  chatWithChatGpt:"/chat/openai/",
  loadUploadFile:"/user/uploadData/",
  loadUserSubscribeRobotList:"/user/",
  loadRobotSquareList:"/user/robotList/",
  loadRobotDetail:"/robot/detail",
  checkCode: "/verify",//验证码
  login: "/user/login",//登录
  ...
  uploadFile: "/upload/openai/",//上传文件地址
